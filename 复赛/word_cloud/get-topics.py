...
if __name__ == "__main__":
    ...
    # 保存详细的主题标签-仓库映射关系
    with open('D:\\MyVScode\\Python\\ItDSaE-openSODA\\wordcloud\\repo_topics-details.json', 'w') as f:
        json.dump(result2, f, indent=4)
    
    # 保存主题标签出现次数统计
    with open('D:\\MyVScode\\Python\\ItDSaE-openSODA\\wordcloud\\repo_topics-count.json', 'w') as f:
