...
with open('D:\\MyVScode\\Python\\ItDSaE-openSODA\\wordcloud\\get300-repo.json', 'r') as f:
    repo_names = json.load(f)

HEADERS = {
    "Authorization": "token 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"  
}# 我的 GitHub Token
...
def get_readme_content(repo_name,owner):
    ...
    try:
        ...
        data=response.json()
        readme_content = base64.b64decode(data['content']).decode('utf-8')# README 文件内容是 base64 编码的
...
with open('D:\\MyVScode\\Python\\ItDSaE-openSODA\\wordcloud\\repo_readme-details.json', 'w') as f:
    json.dump(readme_word_details, f,indent=4)
with open('D:\\MyVScode\\Python\\ItDSaE-openSODA\\wordcloud\\repo_readme-count.json', 'w') as f:
