...
with open(r'D:\MyVScode\Python\ItDSaE-openSODA\wordcloud\hoverframe-repo.json', 'r') as f:
...
with open('D:\\MyVScode\\Python\\ItDSaE-openSODA\\wordcloud\\fetch_topic-description.json', 'w') as f:
