...
# 加载两个文件
with open('D:\\MyVScode\\Python\\ItDSaE-openSODA\\wordcloud\\fetch_topic-description.json', 'r') as f:
    fetch_data = json.load(f)

with open('D:\\MyVScode\\Python\\ItDSaE-openSODA\\wordcloud\\hoverframe-repo.json', 'r') as f:
